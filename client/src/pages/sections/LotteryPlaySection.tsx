  ...
  return (
    <div className="w-full grid grid-cols-1 lg:grid-cols-3 gap-6 px-4 md:px-0">
      ...
      >
        ...
        <div className="relative z-20 flex flex-col gap-6 items-start h-full">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="space-y-2">
              <h2 className="font-['Montserrat'] font-[900] text-[58px] md:text-[84px] text-white leading-[0.85] uppercase tracking-tighter">
                LOTTERY
              </h2>
              <p className="text-[#A1B4C6] text-xl font-medium font-['Outfit'] max-w-[340px] leading-tight opacity-80">
          ...
          {/* Tickets Badge */}
          <div className="flex items-center gap-4 bg-[#1F1813]/60 backdrop-blur-md rounded-[16px] px-5 py-2.5 border border-white/5 shadow-xl">
            <img src="/figmaAssets/image-194-1.png" className="w-6 h-4 object-contain" alt="Ticket" />
            <span className="text-white font-bold text-lg font-['Outfit']">Tickets</span>
            <div className="bg-[#FF4B0F] px-3 py-1 rounded-[8px] shadow-lg">
              <span className="text-white font-black text-xl font-['Montserrat']">5$</span>
            </div>
            <span className="text-white/40 font-black text-md font-['Outfit']">only</span>
          </div>

          {/* Verifiable Badge - Repositioned slightly */}
          <div className="bg-[#58A700] rounded-[24px] p-6 flex flex-col gap-1 min-w-[200px] shadow-[0_10px_40px_rgba(88,167,0,0.3)] backdrop-blur-sm mt-4">
            <div className="flex items-center justify-between gap-4">
              <div className="flex flex-col gap-0.5">
                <span className="text-white font-black text-[16px] font-['Montserrat'] uppercase leading-none">Fully verifiable</span>
                <span className="text-white/70 font-medium text-[12px] font-['Outfit']">on Blockchain.com</span>
              </div>
              <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center">
                <div className="w-6 h-6 bg-white rounded-full flex items-center justify-center">
                  <span className="text-[#58A700] text-[14px] font-bold">✓</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full flex flex-col gap-8">
            <div className="flex flex-wrap items-center gap-8">
              ...
              <div className="flex flex-col gap-2">
                <span className="text-[11px] font-[900] text-white/40 font-['Montserrat'] uppercase tracking-widest">Next draw in</span>
                <div className="flex gap-2">
                  {timerDigits.map((digit, i) => (
                    <div key={i} className="w-[64px] h-[68px] bg-[#13171D] rounded-xl border border-white/10 flex items-center justify-center shadow-inner">
                      <span className="text-white text-[32px] font-black font-['Montserrat']">{digit.value}</span>
                    </div>
                  ))}
                </div>
              </div>
        ...
        {/* Mascot & Floating Assets */}
        <div className="absolute inset-0 pointer-events-none z-10 overflow-hidden">
          <img
            src="/figmaAssets/image-189.png"
            className="absolute right-[-4%] bottom-0 h-[96%] w-auto object-contain z-10"
            alt="Fox Mascot"
          />
          <img src="/figmaAssets/image-193-1.png" className="absolute top-[18%] right-[28%] w-24 opacity-60 blur-[1px] rotate-12" alt="Coin" />
          <img src="/figmaAssets/image-193-1.png" className="absolute bottom-[22%] right-[36%] w-32 opacity-80" alt="Coin" />
          <img src="/figmaAssets/image-194-1.png" className="absolute top-[8%] right-[8%] w-32 opacity-30 rotate-[15deg] blur-[1px]" alt="Ticket" />
        </div>
      </Card>
