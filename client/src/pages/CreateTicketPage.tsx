...
export const CreateTicketPage = (): JSX.Element => {
    ...
    return (
        <div className="w-full flex flex-col items-center gap-10 py-6 md:py-10">
            {/* Back Button Container */}
            <div className="w-full max-w-[1100px] px-4 flex justify-start">
                <BackButton label="Back to Support" href="/faq" />
            </div>

            <div className="w-full max-w-[1100px] flex flex-col gap-10 px-4 overflow-visible">
                {/* Header Title */}
                <div className="flex flex-col items-center gap-3 text-center mb-4">
                    ...
                    <p className="text-[#525D68] text-[14px] md:text-[16px] font-medium font-['Montserrat'] leading-relaxed max-w-[600px]">
                        Describe your issue and we'll help you resolve it efficiently
                    </p>
                </div>

                {/* MAIN GRID: Form and Sidebar */}
                <div className="w-full flex flex-col lg:flex-row gap-8 lg:gap-[32px] items-start justify-center">

                    {/* LEFT: Form Container */}
                    <div
                        className="flex flex-col gap-3 w-full lg:w-[629px] min-h-[558px] bg-[#0D1115] rounded-[32px] p-6 md:p-10 border border-white/5 shadow-2xl"
                    >
                        {/* THE FORM */}
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <input
                                    ...
                                    className="w-full h-[52px] bg-[#11161B] border border-white/5 rounded-[12px] px-5 text-white font-medium font-['Montserrat'] text-[15px] placeholder:text-[#2A333C] focus:border-[#E36826]/50 transition-all outline-none"
                                />
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                <div className="flex flex-col gap-2 relative">
                                    ...
                                    <div className="relative group">
                                        <select className="w-full h-[52px] bg-[#11161B] border border-white/5 rounded-[12px] px-5 text-white font-medium font-['Montserrat'] text-[15px] outline-none appearance-none cursor-pointer focus:border-[#E36826]/50 transition-all">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <input
                                    ...
                                    className="w-full h-[52px] bg-[#11161B] border border-white/5 rounded-[12px] px-5 text-white font-medium font-['Montserrat'] text-[15px] placeholder:text-[#2A333C] focus:border-[#E36826]/50 transition-all outline-none"
                                />
                                <span className="text-[#39424B] text-[11px] font-medium font-['Montserrat'] px-1">You can find this in your ticket history or transaction receipt</span>
                            </div>
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <input
                                    ...
                                    className="w-full h-[52px] bg-[#11161B] border border-white/5 rounded-[12px] px-5 text-white font-medium font-['Montserrat'] text-[15px] placeholder:text-[#2A333C] focus:border-[#E36826]/50 transition-all outline-none"
                                />
                                <span className="text-[#39424B] text-[11px] font-medium font-['Montserrat'] px-1">We will send updates to this email address</span>
                            </div>
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <input
                                    ...
                                    className="w-full h-[52px] bg-[#11161B] border border-white/5 rounded-[12px] px-5 text-white font-medium font-['Montserrat'] text-[15px] placeholder:text-[#2A333C] focus:border-[#E36826]/50 transition-all outline-none"
                                />
                                <span className="text-[#39424B] text-[11px] font-medium font-['Montserrat'] px-1">Provide transaction hash</span>
                            </div>
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <textarea
                                    ...
                                    className="w-full h-[180px] bg-[#11161B] border border-white/5 rounded-[12px] p-5 text-white font-medium font-['Montserrat'] text-[15px] placeholder:text-[#2A333C] focus:border-[#E36826]/50 transition-all outline-none resize-none leading-relaxed"
                                />
                            </div>
                        </div>
