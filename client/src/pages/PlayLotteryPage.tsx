                    ...
                    >
                        ...
                        <CardContent className="relative w-full h-full p-6 md:p-12 flex flex-col justify-center z-20 overflow-hidden">
                            ...
                            <div className="flex flex-col gap-6 md:gap-8 relative z-30 w-full md:w-[60%] h-full justify-center pt-8 md:pt-0 items-start text-left">
                                ...
                                {/* "PLAY LOTTERY" Button */}
                                <button className="inline-flex items-center gap-2 md:gap-3 w-[200px] md:w-[280px] h-[40px] md:h-[60px] rounded-[8px] md:rounded-[12px] pl-1.5 pr-3 pt-1 pb-2 shadow-[0_4px_20px_rgba(143,216,17,0.3)] z-40 transition-transform hover:scale-105 active:scale-95"
