...
const SidebarItem = ({ iconSrc, label, isActive, onClick, variant = "purple", largeIcon = false }: { iconSrc: string, label: string, isActive?: boolean, onClick?: () => void, variant?: "orange" | "purple" | "green", largeIcon?: boolean }) => {
    const cardGradients = {
    ...
    return (
        <div
            ...
            className={cn(
                ...
                isActive && "shadow-[0_0_15px_rgba(227,104,38,0.3)]"
            )}
            style={{
                background: isActive && label === "Home" ? cardGradients.activeHome : cardGradients[variant === "orange" ? "orange" : "purple"]
            }}
        >
            <span className="text-[7px] font-black text-white uppercase tracking-[0.05em] z-10 opacity-60 group-hover:opacity-100 transition-opacity">{label}</span>
...
export const DesktopSidebar = () => {
    return (
        ...
        >
            {/* Logo */}
            <h1 className="font-['Montserrat'] font-[900] text-white text-[10px] tracking-tight leading-none uppercase mb-8">
                LOTTERY
            </h1>
            ...
            <nav className="flex flex-col gap-2 mb-6 items-center w-full">
                ...
                <SidebarItem variant="orange" iconSrc="/figmaAssets/img3.png" label="Home" isActive={true} />
                <SidebarItem variant="purple" iconSrc="/figmaAssets/ball8.png" label="Lottery" />
                <SidebarItem variant="purple" iconSrc="/figmaAssets/img4.png" label="Results" />
                ...
                <SidebarItem variant="purple" iconSrc="/figmaAssets/image-180.png" label="FAQ" />
            </nav>
